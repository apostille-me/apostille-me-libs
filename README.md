# apostille-me-libs (superseded)

> This repository is frozen. The canonical source of truth is [`apme-libs`](https://github.com/apostille-me/apme-libs).
...
- Open issues, pull requests, releases, and new work in `apostille-me/apme-libs`.
- Change Zed dependencies to `"apostille-me/apme-libs" = "^0.1.0"`.
- Point any retained submodule at `apostille-me/apme-libs` and classify it according to the canonical monorepo's composition policy.
